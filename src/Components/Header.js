...
function Header() {
  ...
  return (
    <div class=' p-4 border-b border-gray-100 w-full   px-4'>
       <ul className='bg-white h-16 text-black shadow-md'>
          <a href="Wrafix.Net" className='inline-flex font-semibold text-2xl uppercase font-[Montserrat]  m-4 float-left '>./Wrafix</a>
